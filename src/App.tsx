      ...
      <section id="home" className="min-h-screen flex items-center relative overflow-hidden pt-16 md:pt-20 bg-black">
        <div className="container mx-auto px-4 md:px-6 lg:px-12 relative z-10">
          <div className="grid lg:grid-cols-2 gap-6 md:gap-12 items-center">
            ...
            <div className="relative max-w-[280px] sm:max-w-sm mx-auto lg:max-w-none lg:order-2" style={{ overflow: 'hidden', borderRadius: '50%' }}>
              {/* Glow effect around image - Wrapped in container to hide square edges */}
              <div className="absolute inset-0 rounded-full lg:rounded-3xl overflow-hidden" style={{ 
                borderRadius: '50%',
                WebkitMaskImage: 'radial-gradient(circle, black 70%, transparent 100%)',
                maskImage: 'radial-gradient(circle, black 70%, transparent 100%)'
              }}>
                <div className="absolute inset-0 bg-gradient-to-br from-purple-500/50 via-purple-600/40 to-purple-700/30 blur-3xl opacity-60 animate-pulse"></div>
                <div className="absolute inset-0 bg-gradient-to-br from-purple-400/40 to-purple-600/30 blur-2xl opacity-50"></div>
              </div>
