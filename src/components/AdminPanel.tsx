...
const AdminPanel: React.FC<AdminPanelProps> = ({ onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-gradient-to-br from-gray-950 via-purple-950/20 to-gray-950 overflow-y-auto z-50">
      ...
      <div className="lg:hidden fixed bottom-0 left-0 right-0 bg-gray-900/95 backdrop-blur-xl border-t border-purple-500/20 p-2 z-50">
      ...
      {currentUser && (
        <FloatingChat 
          ...
          onNewMessage={() => {
            addNotification('chat', 'New Message', `${currentUser.name} sent a message`);
          }}
        />
      )}
    </div>
