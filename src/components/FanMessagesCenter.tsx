...
import { Mail, Heart, Music, Calendar, MessageCircle, X, Send, Trash2 } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 gap-4">
          {filteredMessages.map((message) => {
            ...
            return (
              <div
                key={message.id}
                className={`p-4 md:p-6 rounded-xl border transition-all cursor-pointer ${message.status === 'unread'
              ...
              >
                <div className="flex flex-col sm:flex-row items-start gap-4">
                  ...
                  <div className="flex-1 min-w-0 w-full">
                    ...
                    <h3 className="hidden sm:block text-lg font-bold mb-1 text-white">
                      {message.subject || 'No Subject'}
                    </h3>
                    ...
                    <p className="hidden sm:block text-xs mt-2 text-purple-400">
                      {new Date(message.created_at).toLocaleString()}
                    </p>
                  </div>

                  <div className="flex sm:flex-col gap-2 w-full sm:w-auto mt-2 sm:mt-0 justify-end">
                    {message.message_type === 'prayer_request' && !message.is_prayed_for && (
                      <button
                        ...
                        className="flex-1 sm:flex-none px-3 py-2 sm:py-1 text-xs bg-green-600 text-white rounded hover:bg-green-700 text-center"
                      >
                        Mark Prayed
                      </button>
                    )}
                    <button
                      ...
                      className="p-2 rounded hover:bg-red-500/20 transition-colors self-end"
