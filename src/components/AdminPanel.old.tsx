...
const AdminPanel: React.FC<AdminPanelProps> = ({ onClose }) => {
          ...
          <div className="bg-gradient-to-br from-gray-900/90 to-gray-950/90 backdrop-blur-2xl rounded-3xl p-8 border border-purple-500/20 shadow-2xl">
            <div className="text-center mb-8">
              ...
              <div className="mt-4 p-3 bg-purple-500/10 rounded-lg border border-purple-500/20">
                <p className="text-xs text-purple-300 mb-2">Login Credentials:</p>
                <p className="text-xs text-gray-400">Artist: artist@estherreign.com / artist2024</p>
                <p className="text-xs text-gray-400">Editor: editor@estherreign.com / editor2024</p>
              </div>
            </div>
  ...
  // Main Admin Panel
  return (
    <div className="fixed inset-0 bg-gradient-to-br from-[#1a0a2e] via-[#2d1b4e] to-[#1a0a2e] overflow-y-auto z-50">
      <PurpleWebGLBackground />
      ...
      {currentUser && <EnhancedChatWidget currentUser={currentUser} videos={videos} />}
    </div>
  );
};
